        ...
        <div className="projects-box">
          ...
          <div className="wrapper">
            <div className="project-item">
              <img src="/chat_app.png" alt="Chat App" />
              <h2>Live Chat App</h2>
              <p>
            ...
            <div className="project-item">
              <img src="/NETFLIX.webp" alt="Netflix Clone Project" />
              <h2>Netflix Clone</h2>
              <p>
            ...
            <div className="project-item">
              <img src="/ECOMMERCE.webp" alt="Blog Website Project" />
            ...
            <div className="project-item">
              <img src="/Weather.webp" alt="Weather App Project" />
              <h2>Weather App</h2>
              <p>
            ...
            <div className="project-item">
              <img src="/oxytours.webp" alt="Expense Tracker Project" />
